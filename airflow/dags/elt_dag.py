...
from airflow.operatos.docker import DockerOperator
import subprocess
...
dag = DAG(
    ...
    description='ELT and DBT pipeline',
...
t2 = DockerOperator(
    ...
    network_mode="bridge",
    mounts=[
        Mount(source='/Users/apple/Desktop/Data/ETL_Project/transformations',
              target='/dbt', type='bind'),
        Mount(source='/Users/apple/.dbt',
